...
authRouter.post("/register", validateZod(UserSchema), authCtrl.register.bind(authCtrl));
authRouter.post("/login", validateZod(LoginSchema), authCtrl.login.bind(authCtrl));
